...
You must/may not do it.  你绝不可做这事。
You don't have to do it. 不必做，等同于need not。
I gotta tell you the truth. 口语中have to常使用have got to 或 gotta 代替。
It must be true. 对现在状态的推论。
It must have rained last night. 对过去的推论。
```

#### j. ought to

大部分气矿ought to可以用should代替。

```
You should(ought to) be kind to thers. 表示义务、应当。
Since he works hard, he ought to succeed. 推论。
...
躺 vi.：lie lay lain lying.

说谎 vi.：lie lied lied lying.

放置、生产 vt.：lay laid laid laying.d
